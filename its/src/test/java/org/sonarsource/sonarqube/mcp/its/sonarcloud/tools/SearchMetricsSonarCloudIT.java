...
@Tag("SonarCloud")
class SearchMetricsSonarCloudIT extends AbstractSonarCloudStagingIT {

  @Test
  void should_call_search_metrics_against_staging() {
    var result = mcpClient.callTool(SearchMetricsTool.TOOL_NAME, Map.of("ps", 500));
