...
@Tag("SonarCloud")
class ListPullRequestsSonarCloudIT extends AbstractSonarCloudStagingIT {

  @Test
  void should_call_list_pull_requests_against_staging() {
    var result = mcpClient.callTool(ListPullRequestsTool.TOOL_NAME, Map.of("projectKey", fixture.projectKey()));
