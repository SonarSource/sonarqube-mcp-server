...
@Tag("SonarCloud")
class SearchMyProjectsSonarCloudIT extends AbstractSonarCloudStagingIT {

  @Test
  void should_call_search_my_sonarqube_projects_against_staging() {
    var result = mcpClient.callTool(SearchMyProjectsTool.TOOL_NAME, Map.of(
      SearchMyProjectsTool.SEARCH_QUERY_PROPERTY, fixture.projectKey(),
      SearchMyProjectsTool.PAGE_SIZE_PROPERTY, 10));
    ...
    assertStructuredContentContains(result, """
      ...
      }""".formatted(fixture.projectKey(), fixture.projectName()));
  }
}
