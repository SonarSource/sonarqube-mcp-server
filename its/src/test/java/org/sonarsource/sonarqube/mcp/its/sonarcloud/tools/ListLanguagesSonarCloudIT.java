...
@Tag("SonarCloud")
class ListLanguagesSonarCloudIT extends AbstractSonarCloudStagingIT {

  @Test
  void should_call_list_languages_against_staging() {
    var result = mcpClient.callTool(ListLanguagesTool.TOOL_NAME, Map.of(ListLanguagesTool.QUERY_PROPERTY, "java"));
