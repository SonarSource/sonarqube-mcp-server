...
@Tag("SonarCloud")
class ListPortfoliosSonarCloudIT extends AbstractSonarCloudStagingIT {

  @Test
  void should_call_list_portfolios_against_staging() {
    var result = mcpClient.callTool(ListPortfoliosTool.TOOL_NAME, Map.of(
