...
|---------------------------------------|-----------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
| `json`                                | Cursor, VS Code, Windsurf, Gemini, Copilot CLI, Copilot cloud agent, Kiro, Antigravity, Generic (9 total) | `rootKey`, `urlKey`, `typeField`, `stdioTypeField`, `headersKey`, `extraFields`, `envValuePrefix` |
