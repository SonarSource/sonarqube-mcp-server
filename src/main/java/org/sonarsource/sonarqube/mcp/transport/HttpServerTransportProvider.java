 ...
 * <p>
 * This implementation follows the pattern from the MCP SDK and uses Jetty as the servlet container
 * to host the SDK's HttpServletStreamableServerTransportProvider.
 * <p>
 * Features:
 * - Streamable HTTP transport as per MCP specification
...
public class HttpServerTransportProvider {
  ...
  public CompletableFuture<Void> startServer() {
    ...
    var corsFilter = new FilterHolder(CorsFilter.class);
    ...
    // Create Jetty server with specific host binding for security
