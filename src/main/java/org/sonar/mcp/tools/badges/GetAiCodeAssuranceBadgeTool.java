...
public class GetAiCodeAssuranceBadgeTool extends Tool {

  public static final String TOOL_NAME = "get_ai_code_assurance_badge";
  public static final String PROJECT_PROPERTY = "project";
  public static final String TOKEN_PROPERTY = "token";

  private final ServerApi serverApi;

  public GetAiCodeAssuranceBadgeTool(ServerApi serverApi) {
    super(new SchemaToolBuilder()
      .setName(TOOL_NAME)
      .setDescription("Get an SVG badge showing the AI code assurance status for a project")
  ...
  public Tool.Result execute(Tool.Arguments arguments) {
    ...
    var badge = serverApi.projectBadgesApi().getAiCodeAssuranceBadge(project, token);
