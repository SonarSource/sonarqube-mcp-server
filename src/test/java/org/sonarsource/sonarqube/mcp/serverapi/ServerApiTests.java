...
class ServerApiTests {
  ...
  @Test
  void it_should_log_error_response_body_when_elevated_debug_is_enabled() {
    ...
    assertThat(stderrOutput)
      ...
      .contains("status: 403")
      .contains("response body: {\"errors\": [{\"msg\": \"Missing permission\",\"code\":\"insufficient_privileges\"}]}");
  }
