...
class HttpPerRequestPolicyIntegrationTest {
  ...
  @Test
  void should_omit_write_tool_and_reject_call_for_hyphen_read_only_header() throws Exception {
    assertWriteToolBlocked(HttpPolicyHeaders.READ_ONLY_HYPHEN, "true", null, null);
  }

  @Test
  void should_omit_write_tool_and_reject_call_for_underscore_read_only_header() throws Exception {
    assertWriteToolBlocked(HttpPolicyHeaders.READ_ONLY, "true", null, null);
  }

  @Test
  void should_omit_issues_write_tool_and_reject_call_for_hyphen_toolsets_header() throws Exception {
    assertWriteToolBlocked(null, null, HttpPolicyHeaders.TOOLSETS_HYPHEN, "measures");
  }
