...
class ProxiedToolsLoaderInstructionsTest {
  ...
  void composeInstructions_should_return_base_when_provider_has_no_instructions() {
    var config = new ProxiedMcpServerConfig("test", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO), null);
  ...
  void composeInstructions_should_return_base_when_provider_has_blank_instructions() {
    var config = new ProxiedMcpServerConfig("test", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO), "   ");
  ...
  void composeInstructions_should_append_provider_instructions() {
    var config = new ProxiedMcpServerConfig("code-context", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO),
  ...
  void composeInstructions_should_append_multiple_proxied_servers() {
    var config1 = new ProxiedMcpServerConfig("code-context", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO),
      "Use context tools for code analysis.");
    var config2 = new ProxiedMcpServerConfig("security", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO),
  ...
  void composeInstructions_should_skip_proxied_servers_without_instructions() {
    var config1 = new ProxiedMcpServerConfig("provider1", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO),
      "Provider 1 instructions.");
    var config2 = new ProxiedMcpServerConfig("provider2", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO), null);
    var config3 = new ProxiedMcpServerConfig("provider3", "cmd", List.of(), Map.of(), List.of(), Set.of(TransportMode.STDIO),
